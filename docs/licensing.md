...
Complete texts are the root `LICENSE` for AGPL-3.0-or-later and `LICENSES/MPL-2.0.txt` for MPL-2.0. Dependencies and generated material containing upstream code retain their own terms.
